...
def batches(samples, labels=None, steps=100, batch_size=64):
    ...
    Parameters
    ----------
    samples : ndarray (steps, batch_size, data-dimensions)
        A tensor of data. First dimension in this tensor correspond to time steps,
        second one to batches, and third to variables or features.
    labels : ndarray (steps, batch_size, label-dimensions), optional
        A tensor of data. First dimension in this tensor correspond to time steps,
        second one to batches, and third to labels.
    steps : int, optional
